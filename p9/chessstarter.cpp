...
void display(void)
{
    ...
    // Set the color for one side white, and draw its 16 pieces.
    {
        ...
        {//draw pawns
            if (x == 4000) {
                ...
                z = 2000;
                if (t >= 1.8){
                    Interpolate(t, 1.8, 2.2, x, 1000, 2000);
                    Interpolate(t, 1.8, 2.2, z, 3000, 2000);
                }
                else if (t >= 1.4) {
                    Interpolate(t, 1.4, 1.6, x, 2000, 1000);
                    Interpolate(t, 1.4, 1.6, z, 2000, 3000);
                }
                glPushMatrix();
                glTranslatef(x, 0, z);
                glCallList(6);
    ...
    {//draw black peices
        ...
        {//draw king
            ...
            z = 8000;//starting 
            if (t >= 6.2) {
                Interpolate(t, 6.2, 6.6, y, 0, -2100);
                z = 7000;
            }   
            else if (t >= 5.3) {
        ...
        {//draw pawns
            if (x == 4000) {
                ...
                z = 0;
                if (t >= 6.0) {
                    Interpolate(t, 6.0, 6.4, x, 4000, 9000);
                    z = 5000;
                }
                else if (t >= 4.3) {
...
void InitializeMyStuff()
{
    ...
    DrawPiece("/Users/Caleb Delaney/Desktop/CS-3600/StarterChess2018/StarterChess2018/BISHOP.POL");
    glEndList();

    glNewList(2, GL_COMPILE);
    DrawPiece("/Users/Caleb Delaney/Desktop/CS-3600/StarterChess2018/StarterChess2018/KNIGHT.POL");
    glEndList();

    glNewList(3, GL_COMPILE);
    DrawPiece("/Users/Caleb Delaney/Desktop/CS-3600/StarterChess2018/StarterChess2018/ROOK.POL");
    glEndList();

    glNewList(4, GL_COMPILE);
    DrawPiece("/Users/Caleb Delaney/Desktop/CS-3600/StarterChess2018/StarterChess2018/KING.POL");
    glEndList();

    glNewList(5, GL_COMPILE);
    DrawPiece("/Users/Caleb Delaney/Desktop/CS-3600/StarterChess2018/StarterChess2018/QUEEN.POL");
    glEndList();

    glNewList(6, GL_COMPILE);
    DrawPiece("/Users/Caleb Delaney/Desktop/CS-3600/StarterChess2018/StarterChess2018/PAWN.POL");
    glEndList();
